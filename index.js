...
class Resident {
   ...
   introducing() {
      return `Wonderful creature - <b>${this.species}</b>, whose name is <b>${this.name}</b>! Usually the greeting is <b>${this.saying}</b></i> and friends of this inhabitant are <b>${this.friends.join(', ')}</b>. By the wat, this member is owner of`;
   }
}
...
class Human extends Resident {
   ...
   introducing() {
      return super.introducing() + ` <b>${this.legs} legs</b> and <b>${this.hands} hands</b>!`;
   }
}
